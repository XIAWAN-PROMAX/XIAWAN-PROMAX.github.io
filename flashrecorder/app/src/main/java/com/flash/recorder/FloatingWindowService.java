...
/**
 * A tiny draggable floating control that stays on top of every app. One tap on
 * it asks the recorder service to commit the last 30 seconds (and keep going);
 * a second tap stops and finalizes the file. Visuals reflect the recorder state.
 */
public class FloatingWindowService extends Service {

    private static final String TAG = "FlashFloating";
